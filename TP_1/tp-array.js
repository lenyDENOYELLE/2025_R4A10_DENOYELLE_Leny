...
module.exports = {
  ...
  Q2() {
    return getArray().findIndex((elem) => elem < 7);
  },
  ...
  Q5() {
    let arrayWithoutFirstValue = getArray();
    arrayWithoutFirstValue.unshift(0);
    return arrayWithoutFirstValue;
  },
  ...
  Q9() {
    let arrayWithoutLastIndex = getArray();
    arrayWithoutLastIndex.pop();
